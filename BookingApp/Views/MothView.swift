...
//        lblName.leadingAnchor.constraint(equalTo: leadingAnchor).constant.isEqual(to: 30)
//        lblName.trailingAnchor.constraint(equalTo: trailingAnchor).constant.isEqual(to: -50)
